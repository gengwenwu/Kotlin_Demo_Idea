...
// class Foo {
//    private val delegate = Delegate() // 编译器创建的辅助属性，即：delegate
//
//    var p: Type // p 的访问都会调用 delegate 的getValue和setValue方法。
//        set(value: Type) = delegate.setValue(..., value)
//        get() = delegate.getValue(...)
// }

// 3, 按照约定，Delegate类必须具有 getValue 和 setValue方法 (后者仅适用于可变属性)。它们可以是成员函数，也可以是扩展函数。
//
// class Delegate {
